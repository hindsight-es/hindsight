...
type instance Versions TaskCreated = FirstVersion TaskInfo
instance Event TaskCreated
instance UpgradableToLatest TaskCreated 0 where
  upgradeToLatest = id
...
countTasksGeneric store = do
  ...
  readTVarIO countVar
  where
    countTaskHandler :: TVar Int -> EventHandler TaskCreated IO backend
