...
type instance Versions OrderPlaced = '[OrderInfo]
instance Event OrderPlaced
instance MigrateVersion 0 OrderPlaced

type instance MaxVersion OrderPaid = 0
type instance Versions OrderPaid = '[PaymentInfo]
instance Event OrderPaid
instance MigrateVersion 0 OrderPaid
...
Congratulations! You've completed all Hindsight tutorials:
1. Getting Started
...
You now have the tools to build event-sourced applications!
