...
- **Small-scale production** - Systems that don't need horizontal scaling
...
3. **Production scale**: Migrate to PostgreSQL store (scalability)
...
- [`hindsight-postgresql-store`](../hindsight-postgresql-store/) - Scalable production backend
