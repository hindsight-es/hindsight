...
import Hindsight
import Hindsight.Events (Event (..), mkEvent, MaxVersion, Versions, MigrateVersion)
...
main = do
  ...
  counterTableResult <- Pool.use pool $ Session.sql $ mconcat
